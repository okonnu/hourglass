...
@eel.expose
def get_hcases(l, r):
    threading.Timer(900, get_hcases(l,r)).start()
    lcase = hcases(l)
...
eel.start('index.html', host='localhost', port=27011, size=(1280,960), position=(0,0), cmdline_args=['--no-sandbox','--disable-infobars','--start-fullscreen'] )
